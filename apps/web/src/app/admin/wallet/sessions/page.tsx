    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="px-6 py-6 max-w-7xl mx-auto">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">Funding Sessions</h1>
            <p className="text-text-secondary">Latest 100 sessions</p>
          </div>
          <Button
            variant="secondary"
            icon={RefreshCw}
            onClick={() => qc.invalidateQueries({ queryKey: ['admin-wallet-sessions'] })}
          >
            Refresh
          </Button>
        </div>
        <div className="bg-surface rounded-card border border-[#E0E0E0] overflow-hidden">
          {q.isLoading ? (
            ...
            <div className="p-12 text-center">
              <div className="text-text-secondary">No sessions yet</div>
            </div>
          ) : (
