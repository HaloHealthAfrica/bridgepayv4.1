    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="px-6 py-6 max-w-7xl mx-auto">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">Wallet Ledger</h1>
            <p className="text-text-secondary">Latest 100 entries</p>
          </div>
          <Button
            variant="secondary"
            icon={RefreshCw}
            onClick={() => qc.invalidateQueries({ queryKey: ['admin-wallet-ledger'] })}
          >
            Refresh
          </Button>
        </div>
            ...
            <div className="overflow-x-auto">
              ...
              {(q.data?.items || []).map((r: any) => (
                ...
                >
                  ...
                  <div className="text-sm">{r.entry_type}</div>
